...
Detecting unused feature flag is a specific use case of [deleting dead code](/codebase-sdk/guides/deleting-dead-code), isolated to a specific search space.
...
### Related Skills
- [reduce if statements](/codebase-sdk/examples/skills#reduce-if-statement-condition-python)
- [unwrap with statements](/codebase-sdk/examples/skills#unwrap-with-statement-python)
