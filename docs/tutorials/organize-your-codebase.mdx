...
<Tip>
  ...
  [imports](/building-with-codegen/imports-and-exports). See [Moving
  Symbols](/building-with-codegen/moving-symbols) to learn more.
</Tip>

## Basic Symbol Movement

To move a symbol from one file to another, you can use the [move_to_file](/codebase-sdk/core/Function#move-to-file) method.
