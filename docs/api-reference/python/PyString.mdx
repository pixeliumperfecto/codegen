...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/expressions/string.py#L17-L23" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyString" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyString</a> <span className="text-gray-200">]</span></> } description=""/>
