...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/interfaces/has_block.py#L13-L91" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyHasBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyHasBlock</a> <span className="text-gray-200">]</span></> } description=""/>
