...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/statements/match_case.py#L16-L21" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyMatchCase" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyMatchCase</a> <span className="text-gray-200">]</span></> } description=""/>
