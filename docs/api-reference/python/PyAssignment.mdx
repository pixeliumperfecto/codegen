...
icon: ""
description: "An abstract representation of a assignment in python.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/assignment.py#L21-L96" />
...
<Attribute type={ <><a href="/api-reference/python/PyCommentGroup" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyCommentGroup</a> <span className="text-gray-200">| None</span></> } description="Returns the comment group associated with the symbol." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/python/PyCommentGroup" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyCommentGroup</a> <span className="text-gray-200">| None</span></> } description="A property that retrieves the inline comment group associated with a symbol." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Type" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Type</a> <span className="text-gray-200">|</span> <a href="/api-reference/core/TypePlaceholder" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TypePlaceholder</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyParameter" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyParameter</a> <span className="text-gray-200">]</span></> } description="The type annotation associated with this node" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyAssignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyAssignment</a> <span className="text-gray-200">]</span></> } description=""/>


### <span className="text-primary">from_named_expression</span>
Creates a MultiExpression from a Python named expression.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/assignment.py#L39-L62" />
...
<Return return_type={ <><a href="/api-reference/core/MultiExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiExpression</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyAssignmentStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyAssignmentStatement</a> <span className="text-gray-200">,</span> <a href="/api-reference/python/PyAssignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyAssignment</a> <span className="text-gray-200">]</span></> } description="A MultiExpression containing the assignments created from the named expression."/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/assignment.py#L153-L173" />


<Return return_type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">]]</span></> } description="A sorted list of statement nodes where the variable is used."/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/assignment.py#L276-L287" />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/assignment.py#L198-L215" />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/assignment.py#L176-L195" />
