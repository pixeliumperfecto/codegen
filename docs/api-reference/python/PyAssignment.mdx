...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/develop/src/codegen/sdk/python/assignment.py#L21-L98" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/python/PyAssignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyAssignment</a> <span>]</span></> } description=""/>


### <span className="text-primary">from_named_expression</span>
Creates a MultiExpression from a Python named expression.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/develop/src/codegen/sdk/python/assignment.py#L40-L64" />
