...
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/python/PyConditionalExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyConditionalExpression</a> <span>] | None</span></> } description="
" />
