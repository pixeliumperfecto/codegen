...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/expressions/conditional_expression.py#L11-L18" />
...
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyConditionalExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyConditionalExpression</a> <span className="text-gray-200">] | None</span></> } description="
" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyConditionalExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyConditionalExpression</a> <span className="text-gray-200">]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/ternary_expression.py#L29-L52" />
...
<Parameter
    name="node"
    type={ <><a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">| None, optional</span></> }
