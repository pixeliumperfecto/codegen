...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/typescript/TSWhileStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSWhileStatement</a> <span>]</span></> } description="The condition expression of the while loop." />
