...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/statements/while_statement.py#L25-L89" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/python/PyIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyIfBlockStatement</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyCodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyCodeBlock</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyWhileStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyWhileStatement</a> <span className="text-gray-200">]] | None</span></> } description="the statement that will run if the while loop completes, if any." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span className="text-gray-200">]</span></> } description="Returns all function calls within the while statement and its else block." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/python/PyCodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyCodeBlock</a> <span className="text-gray-200">]</span></> } description="Returns a list of all code blocks nested within the while statement." />

### <span className="text-primary">nested_statements</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyWhileStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyWhileStatement</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyWhileStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyWhileStatement</a> <span className="text-gray-200">]</span></> } description=""/>
