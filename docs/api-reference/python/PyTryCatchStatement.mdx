...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/statements/try_catch_statement.py#L24-L98" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/python/PyCatchStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyCatchStatement</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyTryCatchStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyTryCatchStatement</a> <span className="text-gray-200">]]</span></> } description="The exception handlers." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span className="text-gray-200">]</span></> } description="Gets a list of all function calls contained within the try-catch statement." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/python/PyCodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyCodeBlock</a> <span className="text-gray-200">]</span></> } description="Returns all CodeBlocks nested within this try-catch statement." />

### <span className="text-primary">nested_statements</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyTryCatchStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyTryCatchStatement</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyTryCatchStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyTryCatchStatement</a> <span className="text-gray-200">]</span></> } description=""/>
