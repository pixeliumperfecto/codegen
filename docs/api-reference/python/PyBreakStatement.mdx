...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/statements/break_statement.py#L16-L25" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyBreakStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyBreakStatement</a> <span className="text-gray-200">]</span></> } description=""/>
