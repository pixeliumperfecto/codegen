...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/develop/src/codegen/sdk/python/symbol.py#L23-L199" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/python/PySymbol" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PySymbol</a> <span>]</span></> } description=""/>
