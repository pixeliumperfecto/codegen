...
icon: ""
description: "Abstract representation of a python chained attribute.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/expressions/chained_attribute.py#L12-L18" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyChainedAttribute" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyChainedAttribute</a> <span className="text-gray-200">]</span></> } description=""/>
