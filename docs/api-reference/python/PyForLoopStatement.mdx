...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/statements/for_loop_statement.py#L24-L71" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span className="text-gray-200">]</span></> } description="Gets all function calls within this for loop statement." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyForLoopStatement</a> <span className="text-gray-200">]</span></> } description="An item in the iterable object" />

### <span className="text-primary">iterable</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyForLoopStatement</a> <span className="text-gray-200">]</span></> } description="The iterable that is being iterated over" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyForLoopStatement</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyForLoopStatement</a> <span className="text-gray-200">]</span></> } description=""/>
