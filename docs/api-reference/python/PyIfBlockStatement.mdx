...
icon: ""
description: "Pythons implementation of the if/elif/else statement block.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/statements/if_block_statement.py#L22-L106" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyIfBlockStatement</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyIfBlockStatement</a> <span className="text-gray-200">]</span></> } description=""/>
