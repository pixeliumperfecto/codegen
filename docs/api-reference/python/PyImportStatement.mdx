...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/statements/import_statement.py#L20-L34" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyImportStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyImportStatement</a> <span className="text-gray-200">]</span></> } description=""/>
