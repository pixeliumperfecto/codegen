...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/expressions/named_type.py#L12-L21" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyNamedType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyNamedType</a> <span className="text-gray-200">]</span></> } description=""/>
