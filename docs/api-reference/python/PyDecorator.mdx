...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/python/detached_symbols/decorator.py#L12-L54" />
...
<Attribute type={ <><a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span className="text-gray-200">| None</span></> } description="Gets the function call node from the decorator if the decorator is a call." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/python/PyDecorator" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyDecorator</a> <span className="text-gray-200">]</span></> } description=""/>
