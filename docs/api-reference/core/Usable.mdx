...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/interfaces/usable.py#L21-L89" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Usable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Usable</a> <span className="text-gray-200">]</span></> } description=""/>
