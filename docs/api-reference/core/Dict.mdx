...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Unpack" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Unpack</a> <span>[</span> <a href="/api-reference/typescript/TSObjectType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSObjectType</a> <span>] | None</span></> } description="
" />
