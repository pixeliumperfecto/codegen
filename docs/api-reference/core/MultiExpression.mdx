...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/multi_expression.py#L23-L37" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/MultiExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiExpression</a> <span className="text-gray-200">]</span></> } description=""/>
