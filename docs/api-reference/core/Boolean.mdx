...
icon: ""
description: "A boolean value eg.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/boolean.py#L14-L27" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Boolean" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Boolean</a> <span className="text-gray-200">]</span></> } description=""/>
