...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/symbol_groups/dict.py#L29-L69" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Pair" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Pair</a> <span className="text-gray-200">]</span></> } description=""/>
