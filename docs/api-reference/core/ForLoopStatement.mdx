...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/develop/src/codegen/sdk/core/statements/for_loop_statement.py#L25-L53" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/ForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ForLoopStatement</a> <span>] | None</span></> } description="
" />

### <span className="text-primary">iterable</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/core/ForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ForLoopStatement</a> <span>]</span></> } description="
" />
