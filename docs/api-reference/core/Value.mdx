...
sidebarTitle: "Value"
icon: ""
description: "Editable attribute on code objects that has a value.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/value.py#L20-L36" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Value" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Value</a> <span className="text-gray-200">]</span></> } description=""/>
