...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/statements/catch_statement.py#L20-L35" />

### Inherits from
[BlockStatement](/api-reference/core/BlockStatement), [HasBlock](/api-reference/core/HasBlock), [Statement](/api-reference/core/Statement), [Expression](/api-reference/core/Expression), [Editable](/api-reference/core/Editable)
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/CatchStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>CatchStatement</a> <span className="text-gray-200">]</span></> } description=""/>
