...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/statements/attribute.py#L31-L93" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Attribute" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Attribute</a> <span className="text-gray-200">]</span></> } description=""/>
