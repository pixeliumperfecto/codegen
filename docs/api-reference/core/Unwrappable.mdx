...
icon: ""
description: "An abstract representation of an expression that can be unwrapped.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/interfaces/unwrappable.py#L14-L25" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Unwrappable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Unwrappable</a> <span className="text-gray-200">]</span></> } description=""/>
