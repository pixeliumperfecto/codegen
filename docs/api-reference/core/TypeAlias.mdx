...
icon: ""
description: "Abstract representation of a Type object.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/type_alias.py#L31-L72" />
...
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/Attribute" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Attribute</a> <span className="text-gray-200">]</span></> } description="List of expressions defined in this Type object." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/TypeAlias" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TypeAlias</a> <span className="text-gray-200">]</span></> } description=""/>


### <span className="text-primary">get_attribute</span>
Get attribute by name.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/type_alias.py#L59-L61" />
