...
icon: ""
description: "These are groups of symbols that form some kind of logical grouping, like a class or module,
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/symbol_group.py#L26-L278" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/SymbolGroup" style={ {fontWeight: "inherit", fontSize: "inherit"} }>SymbolGroup</a> <span className="text-gray-200">]</span></> } description=""/>
