...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/python/PyCodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyCodeBlock</a> <span>[</span> <a href="/api-reference/python/WithStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>WithStatement</a> <span>]</span></> } description="(PyCodeBlock) the code block of the with statement" />
