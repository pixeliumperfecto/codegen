...
icon: ""
description: "An abstract representation of a union type.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/union_type.py#L24-L57" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/UnionType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>UnionType</a> <span className="text-gray-200">]</span></> } description=""/>
