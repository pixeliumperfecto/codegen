...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/detached_symbols/decorator.py#L28-L55" />
...
<Attribute type={ <><a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span className="text-gray-200">| None</span></> } description="Returns any function call made by this decorator." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Decorator" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Decorator</a> <span className="text-gray-200">]</span></> } description=""/>
