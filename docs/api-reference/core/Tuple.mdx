...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/symbol_groups/tuple.py#L18-L26" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Tuple" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Tuple</a> <span className="text-gray-200">]</span></> } description=""/>
