...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/named_type.py#L26-L75" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/NamedType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>NamedType</a> <span className="text-gray-200">]</span></> } description=""/>
