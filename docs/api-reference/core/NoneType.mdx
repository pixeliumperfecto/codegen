...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/none_type.py#L20-L31" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/NoneType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>NoneType</a> <span className="text-gray-200">]</span></> } description=""/>
