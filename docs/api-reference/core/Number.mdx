...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/number.py#L14-L24" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Number" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Number</a> <span className="text-gray-200">]</span></> } description=""/>
