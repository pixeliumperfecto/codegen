...
<Attribute type={ <><span>Collection[</span> <a href="/api-reference/core/Export" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Export</a> <span>,</span> <a href="/api-reference/core/ExportStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ExportStatement</a> <span>]</span></> } description="A list of the individual exports this statement represents" />
