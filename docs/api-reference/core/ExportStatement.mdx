...
icon: ""
description: "Abstract representation of a single export statement that appears in a file. One export
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/statements/export_statement.py#L29-L117" />
...
<Attribute type={ <><span className="text-gray-200">Collection[</span> <a href="/api-reference/core/Export" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Export</a> <span className="text-gray-200">,</span> <a href="/api-reference/core/ExportStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ExportStatement</a> <span className="text-gray-200">]</span></> } description="A list of the individual exports this statement represents" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/ExportStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ExportStatement</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/TSExport" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSExport</a> <span className="text-gray-200">]</span></> } description="Retrieves a list of re-exported symbols from this export statement." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/ExportStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ExportStatement</a> <span className="text-gray-200">]</span></> } description=""/>
