...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/string.py#L24-L69" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/String" style={ {fontWeight: "inherit", fontSize: "inherit"} }>String</a> <span className="text-gray-200">]</span></> } description=""/>
