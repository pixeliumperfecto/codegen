...
icon: ""
description: "An interface for any node object that can be exported
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/interfaces/exportable.py#L19-L104" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Exportable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Exportable</a> <span className="text-gray-200">]</span></> } description=""/>
