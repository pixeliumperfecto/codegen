...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/unary_expression.py#L25-L62" />
...
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/UnaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>UnaryExpression</a> <span className="text-gray-200">]</span></> } description="The argument of the unary expression" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/UnaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>UnaryExpression</a> <span className="text-gray-200">]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/unary_expression.py#L51-L62" />
