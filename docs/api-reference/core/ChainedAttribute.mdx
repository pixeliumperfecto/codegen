...
icon: ""
description: "An attribute of an object. (IE a method on a class, a function from a module, etc)
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/chained_attribute.py#L27-L133" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/ChainedAttribute" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ChainedAttribute</a> <span className="text-gray-200">]</span></> } description=""/>
