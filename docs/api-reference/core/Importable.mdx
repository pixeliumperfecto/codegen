...
icon: ""
description: "An interface for any node object that can import (or reference) an exportable symbol eg. All nodes that are on the graph must inherit from here
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/interfaces/importable.py#L25-L112" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Importable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Importable</a> <span className="text-gray-200">]</span></> } description=""/>
