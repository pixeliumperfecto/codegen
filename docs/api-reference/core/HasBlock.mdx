...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/interfaces/has_block.py#L23-L140" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/HasBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>HasBlock</a> <span className="text-gray-200">]</span></> } description=""/>
