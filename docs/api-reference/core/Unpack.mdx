...
sidebarTitle: "Unpack"
icon: ""
description: "Unpacking of an iterable.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/unpack.py#L14-L61" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Unpack" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Unpack</a> <span className="text-gray-200">]</span></> } description=""/>
