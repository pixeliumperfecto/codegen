...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/import_resolution.py#L59-L612" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/Exportable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Exportable</a> <span className="text-gray-200">]</span></> } description="Returns the enumerated list of symbols imported from a module import." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Import" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Import</a> <span className="text-gray-200">]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/import_resolution.py#L204-L212" />
