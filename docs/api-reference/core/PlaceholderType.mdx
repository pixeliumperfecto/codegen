...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/placeholder_type.py#L22-L34" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/PlaceholderType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PlaceholderType</a> <span className="text-gray-200">]</span></> } description=""/>
