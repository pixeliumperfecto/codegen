...
icon: ""
description: "Any symbol that can be invoked with arguments eg.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/interfaces/callable.py#L42-L127" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Callable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Callable</a> <span className="text-gray-200">]</span></> } description=""/>
