...
icon: ""
description: "Any comparison expression in the code.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/comparison_expression.py#L13-L59" />
...
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/ComparisonExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ComparisonExpression</a> <span className="text-gray-200">]]</span></> } description="Returns a list of expressions for named child nodes." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/ComparisonExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ComparisonExpression</a> <span className="text-gray-200">] | None</span></> } description="
" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/ExpressionGroup" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ExpressionGroup</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/ComparisonExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ComparisonExpression</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/ComparisonExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ComparisonExpression</a> <span className="text-gray-200">]]</span></> } description="Returns a list of operator expressions in a comparison expression." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/ComparisonExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ComparisonExpression</a> <span className="text-gray-200">]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/binary_expression.py#L105-L127" />
