...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/symbol_groups/list.py#L18-L26" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/List" style={ {fontWeight: "inherit", fontSize: "inherit"} }>List</a> <span className="text-gray-200">]</span></> } description=""/>
