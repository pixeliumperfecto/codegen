...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/generic_type.py#L30-L77" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">Collection[</span> <a href="/api-reference/core/Type" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Type</a> <span className="text-gray-200">,</span> <a href="/api-reference/core/GenericType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>GenericType</a> <span className="text-gray-200">]</span></> } description="Retrieves the generic type parameters associated with this type." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/GenericType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>GenericType</a> <span className="text-gray-200">]</span></> } description=""/>
