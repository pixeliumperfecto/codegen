...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/interfaces/typeable.py#L22-L50" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Typeable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Typeable</a> <span className="text-gray-200">]</span></> } description=""/>
