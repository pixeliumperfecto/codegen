...
sidebarTitle: "File"
icon: ""
description: "Represents a generic file.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/file.py#L51-L342" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/File" style={ {fontWeight: "inherit", fontSize: "inherit"} }>File</a> <span className="text-gray-200">]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/file.py#L326-L337" />

<ParameterWrapper>
<Parameter
    name="G"
    type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">CodebaseGraph</code> }
    description="The codebase graph that the file belongs to."
    defaultValue=""
/>
</ParameterWrapper>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/file.py#L278-L307" />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/file.py#L310-L324" />
