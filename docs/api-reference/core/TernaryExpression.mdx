...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/ternary_expression.py#L21-L72" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/TernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TernaryExpression</a> <span className="text-gray-200">]</span></> } description=""/>
