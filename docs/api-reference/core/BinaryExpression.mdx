...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/expressions/binary_expression.py#L25-L127" />
...
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span className="text-gray-200">]]</span></> } description="Returns all elements in a binary expression chain." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/ExpressionGroup" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ExpressionGroup</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span className="text-gray-200">]]</span></> } description="Returns a list of operators in a chain of binary operations." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/BinaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>BinaryExpression</a> <span className="text-gray-200">]</span></> } description=""/>
