...
icon: ""
description: "Represents an external module, like `datetime`, that can be referenced.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/external_module.py#L26-L154" />
...
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">Literal[NodeType.EXTERNAL]</code> } description="
" />

### <span className="text-primary">parameters</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/Parameter" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Parameter</a> <span className="text-gray-200">]</span></> } description="Returns list of named parameters from an external function symbol." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/ExternalModule" style={ {fontWeight: "inherit", fontSize: "inherit"} }>ExternalModule</a> <span className="text-gray-200">]</span></> } description=""/>


### <span className="text-primary">from_import</span>
Creates an ExternalModule instance from an Import instance.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/external_module.py#L57-L70" />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/external_module.py#L89-L104" />
