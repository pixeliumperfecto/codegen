...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/detached_symbols/parameter.py#L39-L228" />

### Inherits from
[HasValue](/api-reference/core/HasValue), [Expression](/api-reference/core/Expression), [Usable](/api-reference/core/Usable), [Typeable](/api-reference/core/Typeable), [Editable](/api-reference/core/Editable), [Importable](/api-reference/core/Importable), [HasName](/api-reference/core/HasName)
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/core/Parameter" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Parameter</a> <span className="text-gray-200">]</span></> } description=""/>
