...
<HorizontalDivider light={true} />
<Attribute type={ <><span>TSType[</span> <a href="/api-reference/typescript/TSReadonlyType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSReadonlyType</a> <span>]</span></> } description="
" />
