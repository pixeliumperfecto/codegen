...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/statements/for_loop_statement.py#L24-L119" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSForLoopStatement</a> <span className="text-gray-200">] | None</span></> } description="The condition for the loop. Applicable for traditional for loops." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span className="text-gray-200">]</span></> } description="Retrieves all function calls within a for loop statement." />

### <span className="text-primary">increment</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSForLoopStatement</a> <span className="text-gray-200">] | None</span></> } description="The increment expression. Applicable for traditional for loops." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSForLoopStatement</a> <span className="text-gray-200">] | None</span></> } description="The counter variable. Applicable for traditional for loops." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSForLoopStatement</a> <span className="text-gray-200">] | None</span></> } description="An item in the iterable object. Only applicable for `for...of` loops." />

### <span className="text-primary">iterable</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSForLoopStatement</a> <span className="text-gray-200">] | None</span></> } description="The iterable that is being iterated over. Only applicable for `for...of` loops." />

### <span className="text-primary">jsx_elements</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSForLoopStatement</a> <span className="text-gray-200">]]</span></> } description="Returns a list of all JSX elements contained within this symbol." />

### <span className="text-primary">nested_code_blocks</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/CodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>CodeBlock</a> <span className="text-gray-200">]</span></> } description="Returns all nested CodeBlocks within the statement." />

### <span className="text-primary">nested_statements</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSForLoopStatement</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSForLoopStatement</a> <span className="text-gray-200">]</span></> } description=""/>
...
<Return return_type={ <><a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSForLoopStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSForLoopStatement</a> <span className="text-gray-200">] | None</span></> } description="The matching JSX element if found, None otherwise."/>
