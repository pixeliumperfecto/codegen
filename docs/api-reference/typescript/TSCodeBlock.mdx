...
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/AssignmentStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>AssignmentStatement</a> <span>[</span> <a href="/api-reference/typescript/TSCodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSCodeBlock</a> <span>,</span> <a href="/api-reference/core/Assignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Assignment</a> <span>]]</span></> } description="Returns list of top level assignment statements in the code block." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span>list[</span> <a href="/api-reference/core/IfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>IfBlockStatement</a> <span>[</span> <a href="/api-reference/typescript/TSCodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSCodeBlock</a> <span>]]</span></> } description="Returns a list of top level if statements in the code block." />
