...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/expressions/function_type.py#L26-L93" />
...
<HorizontalDivider light={true} />
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">None</code> } description="
" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">Collection[</span> <a href="/api-reference/typescript/TSParameter" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSParameter</a> <span className="text-gray-200">,</span> <a href="/api-reference/typescript/TSFunctionType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSFunctionType</a> <span className="text-gray-200">]</span></> } description="Retrieves the parameters of a function type." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">TSType[</span> <a href="/api-reference/typescript/TSFunctionType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSFunctionType</a> <span className="text-gray-200">] |</span> <a href="/api-reference/typescript/TSReturnTypePlaceholder" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSReturnTypePlaceholder</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSFunctionType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSFunctionType</a> <span className="text-gray-200">]</span></> } description="Return type of the function." />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/expressions/function_type.py#L60-L75" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSFunctionType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSFunctionType</a> <span className="text-gray-200">]</span></> } description=""/>
