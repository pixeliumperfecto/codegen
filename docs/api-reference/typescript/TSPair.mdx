...
sidebarTitle: "TSPair"
icon: ""
description: "A TypeScript pair node that represents key-value pairs in object literals.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/symbol_groups/dict.py#L26-L70" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a></> } description="
" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSPair" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSPair</a> <span className="text-gray-200">]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/symbol_groups/dict.py#L64-L70" />
