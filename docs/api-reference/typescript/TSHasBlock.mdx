...
icon: ""
description: "A TypeScript base class that provides block-level code organization and decorator handling capabilities.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/interfaces/has_block.py#L22-L171" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSHasBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSHasBlock</a> <span className="text-gray-200">]]</span></> } description="Returns a list of all JSX elements contained within this symbol." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSHasBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSHasBlock</a> <span className="text-gray-200">]</span></> } description=""/>
...
<Return return_type={ <><a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSHasBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSHasBlock</a> <span className="text-gray-200">] | None</span></> } description="The matching JSX element if found, None otherwise."/>
