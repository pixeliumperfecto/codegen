...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/expressions/generic_type.py#L16-L29" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">Collection[</span> <a href="/api-reference/core/Type" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Type</a> <span className="text-gray-200">,</span> <a href="/api-reference/typescript/TSGenericType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSGenericType</a> <span className="text-gray-200">]</span></> } description="Retrieves the generic type parameters associated with this type." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSGenericType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSGenericType</a> <span className="text-gray-200">]</span></> } description=""/>
