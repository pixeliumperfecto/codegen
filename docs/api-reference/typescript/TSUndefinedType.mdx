...
icon: ""
description: "Undefined type. Represents the undefined keyword
Examples:
undefined
"
---
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/expressions/undefined_type.py#L19-L33" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSUndefinedType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSUndefinedType</a> <span className="text-gray-200">]</span></> } description=""/>
