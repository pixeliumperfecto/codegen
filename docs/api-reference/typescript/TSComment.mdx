...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/statements/comment.py#L34-L165" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/CodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>CodeBlock</a> <span className="text-gray-200">]</span></> } description="Returns a list of nested code blocks within the statement." />

### <span className="text-primary">nested_statements</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSComment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSComment</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/statements/comment.py#L144-L165" />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/statements/comment.py#L98-L111" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSComment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSComment</a> <span className="text-gray-200">]</span></> } description=""/>


### <span className="text-primary">generate_comment</span>
Generates a TypeScript comment block from the given text content.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/statements/comment.py#L112-L141" />
