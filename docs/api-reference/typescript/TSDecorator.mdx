...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/detached_symbols/decorator.py#L12-L50" />
...
<Attribute type={ <><a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span className="text-gray-200">| None</span></> } description="Retrieves the function call expression associated with the decorator." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSDecorator" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSDecorator</a> <span className="text-gray-200">]</span></> } description=""/>
