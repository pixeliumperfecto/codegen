...
icon: ""
description: "A group of related symbols that represent a comment or docstring in TypeScript
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/symbol_groups/comment_group.py#L14-L127" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSCommentGroup" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSCommentGroup</a> <span className="text-gray-200">]</span></> } description=""/>
