...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSAssignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSAssignment</a> <span>]</span></> } description=""/>
