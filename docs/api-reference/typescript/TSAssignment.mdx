...
icon: ""
description: "A class representing TypeScript assignments, including variable declarations and property assignments.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/assignment.py#L20-L84" />
...
<Attribute type={ <code className="text-sm bg-gray-100 px-2 py-0.5 rounded">list[str]</code> } description="List of valid TypeScript assignment node types that this class can handle." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSAssignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSAssignment</a> <span className="text-gray-200">]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/assignment.py#L45-L68" />
...
<Return return_type={ <><a href="/api-reference/core/MultiExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiExpression</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSAssignmentStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSAssignmentStatement</a> <span className="text-gray-200">,</span> <a href="/api-reference/typescript/TSAssignment" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSAssignment</a> <span className="text-gray-200">]</span></> } description="A MultiExpression object containing the constructed assignments."/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/assignment.py#L71-L84" />
