...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/expressions/query_type.py#L23-L56" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">TSType[</span> <a href="/api-reference/typescript/TSQueryType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSQueryType</a> <span className="text-gray-200">]</span></> } description="
" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSQueryType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSQueryType</a> <span className="text-gray-200">]</span></> } description=""/>
