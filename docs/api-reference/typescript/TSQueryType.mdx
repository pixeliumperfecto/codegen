...
<HorizontalDivider light={true} />
<Attribute type={ <><span>TSType[</span> <a href="/api-reference/typescript/TSQueryType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSQueryType</a> <span>]</span></> } description="
" />
