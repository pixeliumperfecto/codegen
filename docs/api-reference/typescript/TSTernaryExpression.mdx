...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/expressions/ternary_expression.py#L11-L18" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSTernaryExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSTernaryExpression</a> <span className="text-gray-200">]</span></> } description=""/>
