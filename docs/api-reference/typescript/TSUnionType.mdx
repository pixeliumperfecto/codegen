...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/expressions/union_type.py#L14-L21" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSUnionType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSUnionType</a> <span className="text-gray-200">]</span></> } description=""/>
