...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/detached_symbols/jsx/expression.py#L18-L75" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/JSXExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXExpression</a> <span className="text-gray-200">] | None</span></> } description="Returns the editable component of this JSX expression." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/JSXExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXExpression</a> <span className="text-gray-200">]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/detached_symbols/jsx/expression.py#L46-L57" />
