...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/expressions/object_type.py#L66-L81" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSObjectType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSObjectType</a> <span className="text-gray-200">]</span></> } description=""/>
