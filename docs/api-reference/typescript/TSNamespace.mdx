...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSNamespace" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSNamespace</a> <span>]</span></> } description=""/>
