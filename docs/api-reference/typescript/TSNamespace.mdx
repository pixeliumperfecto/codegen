...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/namespace.py#L31-L203" />
...
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/TSClass" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSClass</a> <span className="text-gray-200">]</span></> } description="Get all classes defined in this namespace." />

### <span className="text-primary">code_block</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/typescript/TSCodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSCodeBlock</a></> } description="
" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/TSFunction" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSFunction</a> <span className="text-gray-200">]</span></> } description="Get all functions defined in this namespace." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSNamespace" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSNamespace</a> <span className="text-gray-200">]]</span></> } description="Returns a list of all JSX elements contained within this symbol." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/Symbol" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Symbol</a> <span className="text-gray-200">]</span></> } description="Returns all symbols defined within this namespace, including nested ones." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSNamespace" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSNamespace</a> <span className="text-gray-200">]</span></> } description=""/>


### <span className="text-primary">get_class</span>
Get a class by name from this namespace.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/namespace.py#L130-L138" />


<Return return_type={ <><a href="/api-reference/typescript/TSClass" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSClass</a> <span className="text-gray-200">| None</span></> } description=""/>
...
<Return return_type={ <><a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSNamespace" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSNamespace</a> <span className="text-gray-200">] | None</span></> } description="The matching JSX element if found, None otherwise."/>


### <span className="text-primary">get_enum</span>
Get an enum by name from this namespace.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/namespace.py#L160-L168" />


<Return return_type={ <><a href="/api-reference/typescript/TSEnum" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSEnum</a> <span className="text-gray-200">| None</span></> } description=""/>


### <span className="text-primary">get_function</span>
Get a function by name from this namespace.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/namespace.py#L102-L119" />


<Return return_type={ <><a href="/api-reference/typescript/TSFunction" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSFunction</a> <span className="text-gray-200">| None</span></> } description="The found function, or None if not found"/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/namespace.py#L140-L148" />


<Return return_type={ <><a href="/api-reference/typescript/TSInterface" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSInterface</a> <span className="text-gray-200">| None</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/namespace.py#L170-L190" />


<Return return_type={ <><a href="/api-reference/typescript/TSNamespace" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSNamespace</a> <span className="text-gray-200">| None</span></> } description="The found namespace, or None if not found"/>


### <span className="text-primary">get_nested_namespaces</span>
Get all nested namespaces within this namespace.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/namespace.py#L192-L203" />


<Return return_type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/TSNamespace" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSNamespace</a> <span className="text-gray-200">]</span></> } description="List of all nested namespace objects"/>


### <span className="text-primary">get_symbol</span>
Get a symbol by name from this namespace.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/namespace.py#L71-L91" />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/namespace.py#L150-L158" />


<Return return_type={ <><a href="/api-reference/typescript/TSTypeAlias" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSTypeAlias</a> <span className="text-gray-200">| None</span></> } description=""/>
