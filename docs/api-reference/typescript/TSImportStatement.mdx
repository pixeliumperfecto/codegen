...
<HorizontalDivider light={true} />
<Attribute type={ <><span>Collection[</span> <a href="/api-reference/core/Import" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Import</a> <span>,</span> <a href="/api-reference/python/PyImportStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyImportStatement</a> <span>]</span></> } description="A collection of the individual imports this statement represents" />
