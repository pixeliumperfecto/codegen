...
icon: ""
description: "A class representing an import statement in TypeScript, managing both static and dynamic imports.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/statements/import_statement.py#L20-L45" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">Collection[</span> <a href="/api-reference/core/Import" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Import</a> <span className="text-gray-200">,</span> <a href="/api-reference/python/PyImportStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyImportStatement</a> <span className="text-gray-200">]</span></> } description="A collection of the individual imports this statement represents" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSImportStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSImportStatement</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSImportStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSImportStatement</a> <span className="text-gray-200">]</span></> } description=""/>
