...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/expressions/conditional_type.py#L23-L53" />
...
<Attribute type={ <><span className="text-gray-200">TSType[</span> <a href="/api-reference/typescript/TSConditionalType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSConditionalType</a> <span className="text-gray-200">]</span></> } description="
" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSConditionalType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSConditionalType</a> <span className="text-gray-200">]</span></> } description=""/>
