...
<Attribute type={ <><span>TSType[</span> <a href="/api-reference/typescript/TSConditionalType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSConditionalType</a> <span>]</span></> } description="
" />
