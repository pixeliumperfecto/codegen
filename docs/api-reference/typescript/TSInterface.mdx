...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/interface.py#L28-L96" />
...
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/TSAttribute" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSAttribute</a> <span className="text-gray-200">]</span></> } description="Retrieves the list of attributes defined in the TypeScript interface." />

### <span className="text-primary">code_block</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/CodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>CodeBlock</a></> } description="The code block that contains the interface's body." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSInterface" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSInterface</a> <span className="text-gray-200">]]</span></> } description="Returns a list of all JSX elements contained within this symbol." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">Parents[</span> <a href="/api-reference/core/Type" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Type</a> <span className="text-gray-200">,</span> <a href="/api-reference/typescript/TSInterface" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSInterface</a> <span className="text-gray-200">] | None</span></> } description="All the interfaces that this interface extends." />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/interface.py#L61-L65" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSInterface" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSInterface</a> <span className="text-gray-200">]</span></> } description=""/>


### <span className="text-primary">get_attribute</span>
Returns the attribute with the given name, if it exists.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/interface.py#L53-L58" />


<Return return_type={ <><a href="/api-reference/core/Attribute" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Attribute</a> <span className="text-gray-200">| None</span></> } description=""/>
...
<Return return_type={ <><a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSInterface" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSInterface</a> <span className="text-gray-200">] | None</span></> } description="The matching JSX element if found, None otherwise."/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/interface.py#L69-L75" />


<Return return_type={ <><span className="text-gray-200">list[Interface |</span> <a href="/api-reference/core/Class" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Class</a> <span className="text-gray-200">]</span></> } description=""/>
