...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/develop/src/codegen/sdk/core/interface.py#L62-L66" />
...
<Return return_type={ <><span>CodeFlag[</span> <a href="/api-reference/typescript/TSInterface" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSInterface</a> <span>]</span></> } description=""/>


### <span className="text-primary">get_attribute</span>
Returns the attribute with the given name, if it exists.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/develop/src/codegen/sdk/core/interface.py#L54-L59" />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/develop/src/codegen/sdk/core/interface.py#L70-L76" />
