...
icon: ""
description: "Typescript implementation of the if/elif/else statement block.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/statements/if_block_statement.py#L26-L139" />
...
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/IfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>IfBlockStatement</a> <span className="text-gray-200">]</span></> } description="Returns a list of alternative if/elif/else blocks for the current block." />

### <span className="text-primary">condition</span>
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyIfBlockStatement</a> <span className="text-gray-200">] | None</span></> } description="The condition expression for the if block. None if the block is an else block." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/IfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>IfBlockStatement</a> <span className="text-gray-200">| None</span></> } description="Returns the else block within the if-statement." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span className="text-gray-200">]</span></> } description="Returns all function calls within the if block statement and its alternative blocks." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/CodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>CodeBlock</a> <span className="text-gray-200">]</span></> } description="Returns all nested code blocks within an if/elif/else statement block." />

### <span className="text-primary">nested_statements</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSIfBlockStatement</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/statements/if_block_statement.py#L181-L192" />


<Return return_type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/IfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>IfBlockStatement</a> <span className="text-gray-200">]</span></> } description="A list of elif block statements. Empty list if no elif blocks exist."/>
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSIfBlockStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSIfBlockStatement</a> <span className="text-gray-200">]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/core/statements/if_block_statement.py#L211-L271" />
