...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/detached_symbols/jsx/prop.py#L21-L114" />
...
<Attribute type={ <><a href="/api-reference/typescript/JSXExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXExpression</a> <span className="text-gray-200">| None</span></> } description="Retrieves the JSX expression associated with this JSX prop." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/JSXProp" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXProp</a> <span className="text-gray-200">]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/detached_symbols/jsx/prop.py#L55-L79" />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/detached_symbols/jsx/prop.py#L82-L107" />
