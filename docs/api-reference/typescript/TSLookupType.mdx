...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/expressions/lookup_type.py#L24-L60" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">TSType[</span> <a href="/api-reference/typescript/TSLookupType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSLookupType</a> <span className="text-gray-200">]</span></> } description="
" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSLookupType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSLookupType</a> <span className="text-gray-200">]</span></> } description=""/>
