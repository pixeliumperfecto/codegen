...
<HorizontalDivider light={true} />
<Attribute type={ <><span>TSType[</span> <a href="/api-reference/typescript/TSLookupType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSLookupType</a> <span>]</span></> } description="
" />
