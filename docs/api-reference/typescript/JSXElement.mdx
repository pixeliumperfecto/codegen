...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/detached_symbols/jsx/element.py#L26-L197" />
...
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/JSXProp" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXProp</a> <span className="text-gray-200">]</span></> } description="Returns all JSXProp on this JSXElement, an alias for JSXElement.props." />

### <span className="text-primary">expressions</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/JSXExpression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXExpression</a> <span className="text-gray-200">]</span></> } description="Gets all JSX expressions within the JSX element." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">]</span></> } description="Returns a list of JSX elements nested within the current element." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/JSXProp" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXProp</a> <span className="text-gray-200">]</span></> } description="Retrieves all JSXProps (attributes) from a JSX element." />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/detached_symbols/jsx/element.py#L151-L170" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">]</span></> } description=""/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/detached_symbols/jsx/element.py#L99-L113" />
...
<Return return_type={ <><a href="/api-reference/typescript/JSXProp" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXProp</a> <span className="text-gray-200">| None</span></> } description="The matching JSXProp object if found, None if not found."/>
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/detached_symbols/jsx/element.py#L128-L148" />
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/detached_symbols/jsx/element.py#L180-L190" />
