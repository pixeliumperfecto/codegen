...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/symbol_groups/dict.py#L74-L143" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSDict" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSDict</a> <span className="text-gray-200">]</span></> } description=""/>
