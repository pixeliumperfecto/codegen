...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/statements/switch_statement.py#L18-L27" />
...
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/SwitchCase" style={ {fontWeight: "inherit", fontSize: "inherit"} }>SwitchCase</a> <span className="text-gray-200">]</span></> } description="
" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span className="text-gray-200">]</span></> } description="Returns all function calls within the switch statement." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/CodeBlock" style={ {fontWeight: "inherit", fontSize: "inherit"} }>CodeBlock</a> <span className="text-gray-200">]</span></> } description="Returns all nested CodeBlocks within the switch statement." />

### <span className="text-primary">nested_statements</span>
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSSwitchStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSSwitchStatement</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/python/PyMatchStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>PyMatchStatement</a> <span className="text-gray-200">]</span></> } description="The value to switch on" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSSwitchStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSSwitchStatement</a> <span className="text-gray-200">]</span></> } description=""/>
