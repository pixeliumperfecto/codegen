...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/type_alias.py#L14-L69" />
...
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/TSAttribute" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSAttribute</a> <span className="text-gray-200">]</span></> } description="Retrieves all attributes belonging to this type alias." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSTypeAlias" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSTypeAlias</a> <span className="text-gray-200">]]</span></> } description="Returns a list of all JSX elements contained within this symbol." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSTypeAlias" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSTypeAlias</a> <span className="text-gray-200">]</span></> } description=""/>


### <span className="text-primary">get_attribute</span>
Retrieves a specific attribute from a TypeScript type alias by its name.
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/type_alias.py#L60-L69" />
...
<Return return_type={ <><a href="/api-reference/typescript/TSAttribute" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSAttribute</a> <span className="text-gray-200">| None</span></> } description="The attribute with the specified name if found, None otherwise."/>
...
<Return return_type={ <><a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSTypeAlias" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSTypeAlias</a> <span className="text-gray-200">] | None</span></> } description="The matching JSX element if found, None otherwise."/>
