...
icon: ""
description: "A TypeScript while statement class that represents while loops and manages their condition and code block.
...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/statements/while_statement.py#L18-L32" />
...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSWhileStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSWhileStatement</a> <span className="text-gray-200">]</span></> } description="The condition expression of the while loop." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/FunctionCall" style={ {fontWeight: "inherit", fontSize: "inherit"} }>FunctionCall</a> <span className="text-gray-200">]</span></> } description="Returns all function calls within the while statement block." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSWhileStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSWhileStatement</a> <span className="text-gray-200">]]</span></> } description="Returns a list of all JSX elements contained within this symbol." />
...
<HorizontalDivider light={true} />
<Attribute type={ <><span className="text-gray-200">list[</span> <a href="/api-reference/core/MultiLineCollection" style={ {fontWeight: "inherit", fontSize: "inherit"} }>MultiLineCollection</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Statement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Statement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSWhileStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSWhileStatement</a> <span className="text-gray-200">],</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="Returns a list of statement collections within nested code blocks." />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSWhileStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSWhileStatement</a> <span className="text-gray-200">]</span></> } description=""/>
...
<Return return_type={ <><a href="/api-reference/typescript/JSXElement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>JSXElement</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSWhileStatement" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSWhileStatement</a> <span className="text-gray-200">] | None</span></> } description="The matching JSX element if found, None otherwise."/>
