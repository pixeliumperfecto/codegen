...
<HorizontalDivider light={true} />
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span>[</span> <a href="/api-reference/typescript/TSEnum" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSEnum</a> <span>]</span></> } description="
" />
