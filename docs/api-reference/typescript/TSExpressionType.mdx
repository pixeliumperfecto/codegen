...
<GithubLinkNote link="https://github.com/codegen-sh/codegen-sdk/blob/mintlify-doc-fix/src/codegen/sdk/typescript/expressions/expression_type.py#L16-L27" />
...
<Attribute type={ <><a href="/api-reference/core/Expression" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Expression</a> <span className="text-gray-200">[</span> <a href="/api-reference/typescript/TSExpressionType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSExpressionType</a> <span className="text-gray-200">[</span> <a href="/api-reference/core/Editable" style={ {fontWeight: "inherit", fontSize: "inherit"} }>Editable</a> <span className="text-gray-200">]]</span></> } description="The expression to evaluate that yields the type" />
...
<Return return_type={ <><span className="text-gray-200">CodeFlag[</span> <a href="/api-reference/typescript/TSExpressionType" style={ {fontWeight: "inherit", fontSize: "inherit"} }>TSExpressionType</a> <span className="text-gray-200">]</span></> } description=""/>
